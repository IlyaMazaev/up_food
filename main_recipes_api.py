...
def main():
    ...
    add_new_recipe('Пирог с яблоками и карамелью',
                   'Яблоки твердые, кислых сортов - 2 шт.;Сок лимона;Яйца - 4 шт.;Масло сливочное, растопленное - 225 г;Мука - 3,25 стакана;Разрыхлитель - 3 ч. ложки;Сахар светло-коричневый - 2 стакана;Сахар - 1 ст. ложка;Соль - щепотка;Масло сливочное - 8 ст. ложек;Сахар коричневый - 2/3 стакана;Сок лимона - 1 ст. ложка;Соль (морская) - 1 щепотка',
    ...
    add_new_recipe('Котлеты из мяса индейки',
                   'Мясо индейки - 600 г;Хлеб белый - 1-2 ломтя;Молоко - 0,5 стакана;Яйца - 1 шт.;Масло сливочное - 60 г;Сухари - 0,5 стакана ;Пряности (перец, карри, куркума, чеснок) - по вкусу;Соль - 1 ст. ложка (по вкусу);Масло растительное (или жир) для жаренья - 40 г',
    ...
    add_new_recipe('Жареная цветная капуста в кляре',
                   'Цветная капуста - 600 г;Масло сливочное (или растительное) - 3 ст. ложки;Для кляра:;Яйцо - 1-2 шт.;Сметана - 50 г;Мука - 2-3 ст. ложки;Соль - по вкусу;Перец - по вкусу',
